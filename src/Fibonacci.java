public class Fibonacci {
	...
	/* 输出斐波那契数 */
	public static void printFibonacciNumber(long f1, long f2, int n) {// the
																		// first
																		// number,
																		// the
																		// second
	...
	/* 输出斐波那契数组 */
	public static void printFibonacciArray(long f1, long f2, int n) {// the
																		// first
																		// number,
																		// the
																		// second
	...
	public static void main(String[] args) {
		Fibonacci.printFibonacciNumber(0, 1, 10);// print the 20 advanced
													// fibonacci number
